    ...
    <section id = "collection" class = "py-5">
        <div class = "container">
            <div class = "title text-center">
                <h2 class = "position-relative d-inline-block">Documentos Achados</h2>
         </div>
...
<select class="form-control form-control-sm" name="DocAchado" id="tipoDoc1">
  ...
  <button class="btn botaoRedondo" name="BtnPesquisa" type="submit">Pesquisar</button>
                ...
                <div class = "collection-list mt-4 row gx-0 gy-3">
                    ...
                    $buscar=mysqli_query($con,"select * from documento_achado where tipo_documento ='".$_GET['DocAchado']."' order by id_documento_achado desc;");
                    ...
                    while($dados=mysqli_fetch_array($buscar)) {
                        ?>
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best text-center">
                        <div class = "collection-img position-relative">
                            <img src = "<?php echo '../upload/documentos/'.$dados['foto'] ?>" width="150px" height="200px">
                            
                        </div>

                        <div>
                         
                        <p class = "text-capitalize my-1"><?php echo $dados['tipo_documento'] ?><br> Proprietario:<?php echo $dados['proprietario'] ?></p>
                            <span class = "fw-bold">Contacto de quem achou:<?php echo $dados['telefone_responsavel']  ?></span><br>
